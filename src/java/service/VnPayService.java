...
public class VnPayService {
    ...
    public void initiateVNPayPayment(int orderID, HttpServletRequest req, HttpServletResponse res) throws UnsupportedEncodingException, IOException {
        ...
        String locate = "language_here"; // Retrieve the actual language
