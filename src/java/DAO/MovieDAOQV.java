 ...
 * @author VINHNQ
 */
public class MovieDAOQV extends SQLServerConnect {

    public MovieDAOQV(ServletContext context) throws Exception {
        super();
        connect(context);
    }
    ...
    //
    public List<MovieWithStatus> getMoviesByGenre(String genre) {
    List<MovieWithStatus> list = new ArrayList<>();
