...
//            pstmt.setString(4, user.getEmail());
    ...
    public Movie queryMovie(int movieSlotID) throws SQLException {
        ...
        ResultSet rs = getResultSet(sqlQuery);
        if(rs.next()) return new Movie(rs.getInt("MovieID"), rs.getString("Title"), rs.getString("Synopsis"), rs.getString("DatePublished"), rs.getString("ImageURL"), rs.getFloat("Rating"), rs.getString("Country"), rs.getString("Status"));
        return null;
    }
    // Query movie
