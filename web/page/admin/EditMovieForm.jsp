...
<html>
    ...
    <body>
        ...
        <%--<c:out value="${movie.getImageURL()}"/>--%>
        <div class="container">
            <form action="${pageContext.request.contextPath}/PerformUpdateMovieServlet" method="post" enctype="multipart/form-data">
                ...
                <input
                    ...
                    value="<c:out value="${requestScope.mi.getMovieID()}"/>"
                    />
                ...
                <input
                    ...
                    value="<c:out value="${requestScope.mi.getTitle()}"/>"
                    />
                ...
                <textarea
                    ...
                    required
                    ><c:out value="${requestScope.mi.getSynopsis()}"/></textarea>
                ...
                <div class="imgdiv"><img class="img" src="<c:out value="${requestScope.mi.getImageURL()}"/>"/></div>
                ...
                <input
                    ...
                    name="country"
                    required
                    value="<c:out value="${requestScope.mi.getCountry()}"/>"
                    />
                ...
                <div class="input-group">
                    <input
                        ...
                        value="<c:out value="${requestScope.mi.getLength()}"/>"
                        required
                        />
                ...
                <input
                    ...
                    required
                    value="<c:out value="${requestScope.mi.getLinkTrailer()}"/>"
                    />
        ...
        <script>
                    ...
                    function addTextField(initValue) {
                        if (initValue == null) {
                            initValue = "";
                        }
                        counter++;
...
//                    ---------
        ...
        <c:forEach var="genre" items="${requestScope.genresList}">
            <script>
                addTextField('<c:out value="${genre}" />');
            </script>
        </c:forEach>
