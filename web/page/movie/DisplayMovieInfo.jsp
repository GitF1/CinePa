...
<html>
    ...
    <body>
        <!--  phan noi dung phim :  -->
        <div class="content" style="background-image: url('assets/images/4477479.jpg');">
            <div class="container">
                <div class="row pdt50">
                    ...
                    <div class="content-desc col-9">
                        ...
                        <div class="trailer-part d-flex align-items-center">
                            <span class="clWhite trailer-view js-trailer d-flex align-items-center" style="margin-right: 16px;">
                                <div class="h-6 w-6 rounded-full border-2 border-pink-600 text-white/80" style="margin-right: 8px;">
                                    <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" style="width: 24px; height: 24px;">
                        ...
                        <c:forEach var="item" items="${listAvailableMovies}">
                            <div class="active-film row">
                                <div class="active-film-img col-4">
                                    <a href="HandleDisplayMovieInfo?movieID=${item.getMovieID()}" class="active-film-img-a">
